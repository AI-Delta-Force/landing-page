  ...
  return (
    <Section className="pt-8 pb-20 relative overflow-hidden">
      ...
      <Container variant="narrow" className="text-center">
        ...
        <button className="inline-flex items-center gap-3 px-8 py-4 bg-white text-black font-semibold rounded-xl hover:bg-zinc-100 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-lg shadow-white/10 mb-4">
